...
const UserSidebar = ({ setisMenuOpen, isMenuOpen, OpenCategoryForm }) => {
    ...
    return (
        <div
            ...
            } md:flex fixed top-0 left-0 h-screen w-full md:w-64 bg-white dark:bg-zinc-950 flex flex-col p-4 z-50 md:z-10 transition-transform transform ${
        ...
        >
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar">
                <div className="flex justify-between items-center pt-8 text-black dark:text-gray-200">
                    <h2 className="font-bold text-3xl">Task Ease</h2>
                    <button
                ...
                <div className="side_bar_links mt-6 space-y-2">
                    ...
                    <div className="flex justify-between items-center">
                        <h3 className="font-semibold text-lg dark:text-gray-400">Categories</h3>
                        <button
                            onClick={OpenCategoryForm}
                            className="bg-purple-600 text-white px-3 py-1 rounded-md text-sm hover:bg-purple-700 border"
                        >
                            Add
                        </button>
                    </div>
            ...
            <div className="p-2 bg-white dark:bg-zinc-950 space-y-2 border-t border-gray-200 dark:border-zinc-700">
                <button className="w-full font-medium p-3 rounded-md flex gap-2 hover:bg-zinc-300 dark:hover:bg-zinc-800 text-gray-700 dark:text-gray-400">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        width={24}
